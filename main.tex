...
\section{Súlyozás}
    ...
    \begin{definition}[Súly]
        Egy osztály egy példányának $\ent{x}{e}_i$ paraméteréhez tartozó súlya azt fejezi ki, mennyire befolyásolja a fairséget egy $y\sim x$ példány $\ent{y}{e}_i$ paraméterétől való erős eltérés. 
    ...
    \begin{theorem}
        ...
        \begin{proof}
            ...
            \end{equation}
            \begin{align}
                w_i d_i(x, y) &= w_i |x_i - y_i| \\
                &= |w_i x_i - w_i y_i| \\
                &= d_i(wx, wy)
            \end{align}
            Azaz a $\ent w e$-vel súlyozott távolságokból számított $d$ értéke megegyezik a súlyozott entitások $d$ távolságával.
        \end{proof}
    \end{theorem}
    ...
    Paraméterek esetén, ha több is ugyanazt az információt hordozza magában, tehát valamely $e$-re $$\forall x: \ \ent x e _i \propto \ent x e _j,$$ vagy máshogyan kifejezve $e_i \propto e_j$, akkor (hiába lehetséges, hogy eltérően definiálja $p$ ezen értékeket) az információt redukálnunk kell 1 paraméterbe.
    ...
    \begin{theorem}
        ...
        \begin{proof}
            ...
            Ekkor normálás után $\forall i: R_i$ értékkészlete azonos ($[0;1]$), tehát súlyuk a távolságszámításban azonos (leszámítva a $\ent w e$ együtthatókat). 
    ...
    \begin{definition}[Paraméter redundanciaegyütthatója]
        Amennyiben két (vagy több) paraméter egy $\ent x e$ entitásban redundáns, redundanciaegyütthatójuk egy olyan érték, mellyel elérjük, hogy összesen akkora súlyúak legyenek, mint egyetlen független paraméter.
